...
INSERT INTO `acl_permission` VALUES ('14', '4', '分配权限', '', 'role.assgin', '2', '5', '2021-05-31 18:05:37', '2022-01-20 15:18:45', '1');
...
CREATE TABLE `hse_community` (
  ...
  `province_id` bigint(20) DEFAULT NULL COMMENT '省id：（字典id） 预留字段',
  `city_id` bigint(20) DEFAULT NULL COMMENT '城市id：（字典id）预留字段',
  `area_id` bigint(20) DEFAULT NULL COMMENT '区域id：（字典id）',
  `plate_id` bigint(20) DEFAULT NULL COMMENT '板块id：（字典id）',
  ...
  `build_num` int(11) DEFAULT NULL COMMENT '楼栋数',
  `house_num` int(11) DEFAULT NULL COMMENT '房屋数',
  `average_price` decimal(10,2) DEFAULT NULL COMMENT '均价',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(3) NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='小区信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=110338 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='组织架构表';
...
CREATE TABLE `hse_house` (
  ...
  `floor_id` bigint(20) DEFAULT NULL COMMENT '楼层（字典id）',
  `build_structure_id` bigint(20) DEFAULT NULL COMMENT '建筑结构：（字典id）',
  `direction_id` bigint(20) DEFAULT NULL COMMENT '朝向：（字典id）',
  `decoration_id` bigint(20) DEFAULT NULL COMMENT '装修情况：（字典id）',
  `house_use_id` bigint(20) DEFAULT NULL COMMENT '房屋用途：（字典id）',
  ...
  `is_deleted` tinyint(3) NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='房源表';
...
CREATE TABLE `hse_house_broker` (
  ...
  `is_deleted` tinyint(3) NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='房源经纪人';
...
CREATE TABLE `hse_house_image` (
  ...
  `type` tinyint(3) DEFAULT NULL COMMENT '1：普通图片 2：房产图片',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(3) NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='房源图片';
...
CREATE TABLE `hse_house_user` (
  ...
  `phone` varchar(11) DEFAULT NULL COMMENT '手机',
  `sex` tinyint(3) DEFAULT '1' COMMENT '性别 1:男 2：女',
  `id_no` varchar(20) DEFAULT NULL COMMENT '身份证号',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(3) NOT NULL DEFAULT '0' COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='房东信息表';
